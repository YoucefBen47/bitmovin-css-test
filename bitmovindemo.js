  ...
  return (function () {
  ...
  })()(
    {
      ...
      5: [
        ...
        { "../localization/i18n": 85, "../stringutils": 92, "./label": 27 },
      ],
      6: [
        function (e, t, n) {
          "use strict";
      ...
      7: [
        ...
        { "../localization/i18n": 85, "./togglebutton": 69 },
      ],
      8: [
        function (e, t, n) {
          "use strict";
        ...
        { "../localization/i18n": 85, "./selectbox": 41 },
      ],
      9: [
        function (e, t, n) {
          "use strict";
      ...
      11: [
        ...
        { "../timeout": 94, "./component": 18, "./container": 19 },
      ],
      12: [
        function (e, t, n) {
          "use strict";
      ...
      13: [
        ...
        { "../localization/i18n": 85, "./container": 19, "./label": 27 },
      ],
      14: [
        function (e, t, n) {
          "use strict";
      ...
      17: [
        ...
        { "../localization/i18n": 85, "./button": 12 },
      ],
      18: [
        function (e, t, n) {
          "use strict";
          ...
          var i = e("./togglebutton"),
            r = (function (e) {
              function t(t) {
                void 0 === t && (t = {});
                var n = e.call(this, t) || this,
                  o = { cssClass: "ui-customclosetogglebutton", text: "close" };
      ...
      22: [
        function (e, t, n) {
              ...
              return (
                ...
                (t.prototype.configure = function (t, n) {
                  ...
                  var r = this.getConfig(),
                    s = function (e, t) {
                      var s = o(n.getConfig().errorMessages || r.messages, e);
                      s && (t = s),
                        i.errorLabel.setText(t),
                        i.tvNoiseBackground.start(),
                        i.show();
                    };
                  if (c.isMobileV3PlayerAPI(t)) {
                    var a = function (e) {
                      var t =
                        l.ErrorUtils.defaultMobileV3ErrorMessageTranslator(e);
                      s(e, t);
                    };
                    t.on(c.MobileV3PlayerEvent.PlayerError, a),
                      t.on(c.MobileV3PlayerEvent.SourceError, a);
                  } else
          ...
          n.ErrorMessageOverlay = u;
        },
        {
          "../errorutils": 80,
          "../mobilev3playerapi": 89,
          "./container": 19,
          "./label": 27,
          "./tvnoisecanvas": 70,
        },
      ...
      25: [
        ...
        { "../dom": 79, "../localization/i18n": 85, "./button": 12 },
      ],
      26: [
        function (e, t, n) {
          "use strict";
        ...
        { "../dom": 79, "../localization/i18n": 85, "./listselector": 29 },
      ],
      27: [
        function (e, t, n) {
          "use strict";
            ...
            c = (function (e) {
              function t(t) {
                ...
                return (
                  (n.listSelectorEvents = {
                    onItemAdded: new s.EventDispatcher(),
                    onItemRemoved: new s.EventDispatcher(),
                    onItemSelected: new s.EventDispatcher(),
                  }),
                  (n.config = n.mergeConfig(
                    t,
              ...
              return (
                ...
                (t.prototype.addItem = function (e, t, n, o) {
                  ...
                  var r = i(
                    { key: e, label: l.i18n.performLocalization(t) },
                    o && { ariaLabel: o }
                  );
                  if (!this.config.filter || this.config.filter(r)) {
                    if (
                      (this.config.translator &&
                        (r.label = this.config.translator(r)),
                      this.removeItem(e),
                      n)
                    ) {
                      ...
                      s < 0 ? this.items.push(r) : this.items.splice(s, 0, r);
                ...
                (t.prototype.removeItem = function (e) {
                  ...
                  return (
                    t > -1 &&
                    (a.ArrayUtils.remove(this.items, this.items[t]),
              ...
              return (
                ...
                (t.prototype.configure = function (t, n) {
                  ...
                  t.on(t.exports.PlayerEvent.ViewModeChanged, r),
                    ...
                    this.onClick.subscribe(function () {
                      if (!i())
                        return void (console && console.log("PIP unavailable"));
                      var e =
                        t.getViewMode() === t.exports.ViewMode.PictureInPicture
                          ? t.exports.ViewMode.Inline
                          : t.exports.ViewMode.PictureInPicture;
                    ...
                    this.defaultPlaybackSpeeds
                      ...
                      .forEach(function (e) {
                        1 !== e
                          ...
                          : t.addItem(String(e), r.i18n.getLocalizer("normal"));
                      });
                }),
                (t.prototype.clearItems = function () {
                  (this.items = []), (this.selectedItem = null);
          ...
          var c = (function (e) {
            ...
            return (
              ...
              (t.prototype.configure = function (t, n) {
                ...
                t.on(t.exports.PlayerEvent.TimeChanged, v),
                  t.on(t.exports.PlayerEvent.Seeked, v),
                ...
                n.getConfig().events.onUpdated.subscribe(m), m();
              }),
              (t.prototype.setTime = function (e, t) {
                ...
                switch (this.config.timeLabelMode) {
                  ...
                  case i.RemainingTime:
                    var r = a.StringUtils.secondsToTime(t - e, this.timeFormat);
                    this.setText("" + r);
                }
              }),
              ...
              return (
                ...
                (t.prototype.configure = function (n, o, i) {
                  ...
                  var a = !1,
                    l = function () {
                      a ||
                        (n.isPlaying() || s.isPlayInitiated ? s.on() : s.off());
                    };
      ...
      35: [
        ...
        { "./container": 19, "./hugeplaybacktogglebutton": 24 },
      ],
      36: [
        function (e, t, n) {
          "use strict";
                ...
                (n.playbackPositionPercentage = 0),
                  ...
                  (n.seek = function (e) {
                    if (n.player.isLive()) {
                      ...
                      var o = l.PlayerUtils.getSeekableRangeStart(n.player, 0),
              ...
              return (
                ...
                (t.prototype.updateBufferLevel = function (e) {
                  ...
                  (t = this.player.isLive()
                    ? 100
                    : e + d.getMinBufferLevel(this.player)),
                ...
                (t.prototype.configure = function (n, o, i) {
                  ...
                  var s = !1,
                    ...
                    p = function (e, o) {
                      if (
                        ...
                        var i = r.getPlaybackPositionPercentage();
                        if (
                          (r.updateBufferLevel(i),
                          a &&
                            e.type ===
                              n.exports.PlayerEvent.SegmentRequestFinished &&
                            i !== r.playbackPositionPercentage &&
                            (i = r.playbackPositionPercentage),
                          n.isLive())
                        )
                          0 === n.getMaxTimeShift()
                            ? r.setPlaybackPosition(100)
                            : (r.isSeeking() || r.setPlaybackPosition(i),
                  ...
                  n.on(n.exports.PlayerEvent.Seek, f),
                    ...
                    this.onSeekPreview.subscribe(function (e, t) {
                      o.onSeekPreview.dispatch(e, t), (a = t.scrubbing);
                    }),
                ...
                (t.prototype.toDomElement = function () {
                  ...
                  return (
                    n.on("touchstart mousedown", function (t) {
                      var n =
                        f.BrowserUtils.isTouchSupported && e.isTouchEvent(t);
                      t.preventDefault(),
                        null != e.player.vr && t.stopPropagation(),
                        e.setSeeking(!0),
                        (u = !0),
                ...
                (t.prototype.getOffset = function (e) {
                  return f.BrowserUtils.isTouchSupported && this.isTouchEvent(e)
                    ? this.config.vertical
            ...
            u = (function (e) {
                ...
                return (
                  ...
                  (n.handleSeekPreview = function (e, t) {
                    if (n.player.isLive()) {
                      ...
                      n.setTime(s);
                      var a = c.PlayerUtils.getSeekableRangeStart(n.player, 0),
                        l = s + a;
                    ...
                    if (
                      ...
                      var u = (t.marker.marker.cssClasses || []).map(function (
                        e
                      ) {
              ...
              return (
                ...
                (t.prototype.setTime = function (e) {
                  this.setText(a.StringUtils.secondsToTime(e, this.timeFormat));
                }),
              ...
              return (
                ...
                (e.prototype.addLabel = function (e, t) {
                  var n = this.getRegion(e),
                    ...
                    i = n.regionName,
                    r = ["subtitle-position-" + i];
                  if (
                    (e.vtt &&
                      e.vtt.region &&
                      r.push("vtt-region-" + e.vtt.region.id),
                    !this.subtitleRegionContainers[o])
                  ) {
                    var s = new h({ cssClasses: r });
                    (this.subtitleRegionContainers[o] = s),
                      e.regionStyle
                        ? s.getDomElement().attr("style", e.regionStyle)
                        : e.vtt && !e.vtt.region
                        ? s.getDomElement().css("position", "static")
                        : s.getDomElement();
                    for (var a in this.subtitleRegionContainers)
      ...
      53: [
              ...
              return (
                ...
                (t.prototype.configure = function (t, n) {
                  ...
                  e.prototype.configure.call(this, t, n),
                    ...
                    this.addItem("white", r.i18n.getLocalizer("colors.white")),
                    this.addItem("black", r.i18n.getLocalizer("colors.black")),
                    this.addItem("red", r.i18n.getLocalizer("colors.red")),
                    this.addItem("green", r.i18n.getLocalizer("colors.green")),
        ...
        { "../../localization/i18n": 85, "./subtitlesettingselectbox": 60 },
      ],
      54: [
        function (e, t, n) {
          "use strict";
      ...
      61: [
        ...
        { "../../dom": 79, "../../localization/i18n": 85, "../container": 19 },
      ],
      62: [
        function (e, t, n) {
          "use strict";
      ...
      63: [
        function (e, t, n) {
          ...
          var i = e("../settingspanelpage"),
            ...
            v = e("../settingspanelpagebackbutton"),
            m = e("../settingspanelitem"),
                  ...
                  (n.config = n.mergeConfig(
                    t,
                    {
                      components: [
                        ...
                        new m.SettingsPanelItem(
                          y.i18n.getLocalizer("settings.subtitles.font.family"),
                        ...
                        new m.SettingsPanelItem(
                          y.i18n.getLocalizer("settings.subtitles.font.color"),
                        ...
                        new m.SettingsPanelItem(
                          new v.SettingsPanelPageBackButton({
      ...
      67: [
        function (e, t, n) {
          ...
          function i(e, t, n) {
            return t.isLive()
              ? n -
                  (c.PlayerUtils.getSeekableRangeRespectingLive(t).end - e.time)
              : e.time;
          }
          function r(e) {
        ...
        { "../dom": 79, "../playerutils": 90, "../timeout": 94 },
      ],
      68: [
        function (e, t, n) {
          "use strict";
            ...
            s = (function (e) {
              function t(t) {
                ...
                return (
                  ...
                  (n.config = n.mergeConfig(t, o, n.config)),
                  n
                );
              }
              return (
              ...
              return (
                ...
                (t.prototype.configurePlayerStates = function (e, n) {
                  ...
                  for (var l in a.PlayerUtils.PlayerState)
                    if (isNaN(Number(l))) {
                      var c =
                        a.PlayerUtils.PlayerState[a.PlayerUtils.PlayerState[l]];
                  ...
                  var u = function () {
                    ...
                    p = function (e) {
                      u(), i.addClass(s[e]), o.playerStateChange.dispatch(o, e);
                    };
              ...
              return (
                ...
                (t.prototype.configure = function (t, n) {
                  ...
                  i.getDomElement().on("mouseenter", function () {
                    r.isHidden() && r.show(), o.volumeSliderHideTimeout.clear();
                  }),
      ...
      74: [
        ...
        { "../localization/i18n": 85, "./seekbar": 37 },
      ],
      75: [
        function (e, t, n) {
          "use strict";
      ...
      77: [
        ...
        { "../localization/i18n": 85, "./clickoverlay": 16 },
      ],
      78: [
        function (e, t, n) {
          "use strict";
          ...
          var o = e("./components/vrtogglebutton"),
            ...
            x = e("./components/videoqualityselectbox"),
            T = e("./uimanager"),
            M = e("./components/titlebar"),
            L = e("./components/bufferingoverlay"),
            A = e("./components/subtitlelistbox"),
            I = e("./components/audiotracklistbox"),
                  ...
                  components: [
                    ...
                    new w.Container({
                      components: [
                        ...
                        new E.SeekBar({ label: new P.SeekBarLabel() }),
                        new s.PlaybackTimeLabel({
              ...
              function t(t, n) {
                ...
                return (
                  ...
                  (o.rateLimitingEventListener = function (e, t) {
                    if (o.shouldFireEvent()) return o.fireSuper(e, t), void i();
                ...
                (this.bitmovinUiPrefix = e),
                  ...
                  (this.onKeyDown = function (e) {
                    e.metaKey ||
                      e.altKey ||
                      e.ctrlKey ||
                      (t.lastInteractionWasKeyboard = !0);
                  }),
                  ...
                  (this.onFocus = function (e) {
                    var n = e.target;
                    t.lastInteractionWasKeyboard &&
                      i(n) &&
                      o(n, t.bitmovinUiPrefix) &&
                      !n.classList.contains(r) &&
                      n.classList.add(r);
                  }),
                  (this.onBlur = function (e) {
                    var t = e.target;
                    i(t) && t.classList.remove(r);
                  }),
      ...
      85: [
        ...
        { "./languages/de.json": 86, "./languages/en.json": 87 },
      ],
      86: [
        function (e, t, n) {
          t.exports = {
      ...
      88: [
        function (e, t, n) {
          ...
          var v = e("./components/hugeplaybacktogglebutton");
          Object.defineProperty(n, "HugePlaybackToggleButton", {
            enumerable: !0,
            get: function () {
              return v.HugePlaybackToggleButton;
            },
          });
          var m = e("./components/playbacktimelabel");
          Object.defineProperty(n, "PlaybackTimeLabel", {
            enumerable: !0,
            get: function () {
              return m.PlaybackTimeLabel;
            },
          }),
            Object.defineProperty(n, "PlaybackTimeLabelMode", {
              enumerable: !0,
              get: function () {
                return m.PlaybackTimeLabelMode;
              },
            });
          ...
          var E = e("./components/vrtogglebutton");
          Object.defineProperty(n, "VRToggleButton", {
            enumerable: !0,
            get: function () {
              return E.VRToggleButton;
            },
          });
          var x = e("./components/watermark");
          ...
          var A = e("./components/audioqualityselectbox");
          Object.defineProperty(n, "AudioQualitySelectBox", {
            enumerable: !0,
            get: function () {
              return A.AudioQualitySelectBox;
            },
          });
          var I = e("./components/audiotrackselectbox");
          ...
          var G = e("./components/adclickoverlay");
          ...
          var Q = e("./components/playbackspeedselectbox");
          ...
          Object.defineProperty(n, "SubtitleSettingsResetButton", {
            enumerable: !0,
            get: function () {
              return ve.SubtitleSettingsResetButton;
            },
          });
          var me = e("./components/listbox");
          ...
          var _e = e("./components/subtitlesettings/subtitlesettingspanelpage");
          ...
          var Oe = e("./components/customclosebutton");
          Object.defineProperty(n, "CustomCloseButton", {
            enumerable: !0,
            get: function () {
              return Oe.CustomCloseButton;
            },
          }),
        ...
        },
        {
          ...
          "./components/container": 19,
          "./components/controlbar": 20,
          "./components/customclosebutton": 21,
          "./components/errormessageoverlay": 22,
          "./components/fullscreentogglebutton": 23,
      ...
      89: [
        function (e, t, n) {
          ...
          })((i = n.MobileV3PlayerEvent || (n.MobileV3PlayerEvent = {}))),
            (n.isMobileV3PlayerAPI = o);
        },
        {},
      ],
      90: [
      ...
      95: [
        function (e, t, n) {
          ...
          var o = e("./components/subtitleoverlay"),
            ...
            v = e("./components/container"),
            m = e("./components/playbacktimelabel"),
            ...
            E = e("./components/vrtogglebutton"),
            x = e("./components/settingstogglebutton"),
            T = e("./components/fullscreentogglebutton"),
            M = e("./components/uicontainer"),
            L = e("./components/bufferingoverlay"),
            A = e("./components/playbacktoggleoverlay"),
            I = e("./components/caststatusoverlay"),
            ...
            K = e("./uimanager"),
            G = e("./localization/i18n"),
            Q = e("./components/customclosebutton");
          !(function (e) {
            function t(t, n) {
            ...
            function X() {
                ...
                t = new i.SettingsPanelPage({
                  components: [
                    new r.SettingsPanelItem(
                      G.i18n.getLocalizer("settings.video.quality"),
                      new s.VideoQualitySelectBox()
                    ),
                    new r.SettingsPanelItem(
                      G.i18n.getLocalizer("speed"),
                      new a.PlaybackSpeedSelectBox()
                    ),
                    new r.SettingsPanelItem(
                      G.i18n.getLocalizer("settings.audio.track"),
                      new l.AudioTrackSelectBox()
                    ),
                    new r.SettingsPanelItem(
                      G.i18n.getLocalizer("settings.audio.quality"),
              ...
              var H = new h.ControlBar({
                components: [
                  ...
                  new v.Container({
                    components: [
                      new m.PlaybackTimeLabel({
                        timeLabelMode: m.PlaybackTimeLabelMode.CurrentTime,
                        hideInLivePlayback: !0,
                      }),
                      new y.SeekBar({ label: new b.SeekBarLabel() }),
                      new m.PlaybackTimeLabel({
                        timeLabelMode: m.PlaybackTimeLabelMode.TotalTime,
                        cssClasses: ["text-right"],
                      }),
                    ],
                    cssClasses: ["controlbar-top"],
                  ...
                  new v.Container({
                    components: [
                      ...
                      new E.VRToggleButton(),
                      new x.SettingsToggleButton({ settingsPanel: n }),
            ...
            function oe(e, t) {
              return void 0 === t && (t = {}), new K.UIManager(e, ee(), t);
            }
            (e.buildDefaultUI = t),
              (e.buildDefaultSmallScreenUI = n),
              (e.buildDefaultCastReceiverUI = Y),
              (e.modernUI = X),
              (e.modernAdsUI = J),
              (e.modernSmallScreenUI = Z),
              (e.modernSmallScreenAdsUI = $),
              (e.modernCastReceiverUI = ee),
              (e.buildModernUI = te),
              (e.buildModernSmallScreenUI = ne),
              (e.buildModernCastReceiverUI = oe);
          ...
          var a = e("./components/uicontainer"),
            ...
            y = (function () {
              function e(e, t, n) {
                ...
                (this.player = e),
                  (this.managerPlayerWrapper = new C(e)),
                ...
                f.on(this.player.exports.PlayerEvent.SourceLoaded, p),
                  m.isMobileV3PlayerAPI(f) &&
                    f.on(m.MobileV3PlayerEvent.PlaylistTransition, p),
                  n.container
                ...
                for (
                  var g = [], h = 0, y = this.uiVariants;
                  h < y.length;
                  h++
                ) {
                  var b = y[h];
                  null == b.condition && g.push(b),
                    this.uiInstanceManagers.push(new P(e, b.ui, this.config));
                }
                if (g.length > 1)
                  throw Error(
                ...
                if (
                  g.length > 0 &&
                  g[0] !== this.uiVariants[this.uiVariants.length - 1]
                )
                  throw Error(
                    ...
                    if (null != t)
                      switch (t.type) {
                        ...
                        case e.exports.PlayerEvent.AdBreakFinished:
                          (S = null), o.config.events.onUpdated.dispatch(o);
                          break;
                ...
                this.config.autoUiVariantResolve &&
                  (this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.SourceLoaded, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.SourceUnloaded, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.Play, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.Paused, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.AdStarted, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.AdBreakFinished, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.PlayerResized, _),
                  this.managerPlayerWrapper
                    .getPlayer()
                    .on(this.player.exports.PlayerEvent.ViewModeChanged, _)),
      ...
      99: [
        function (e, t, n) {
          ...
          var s = new Map([
            ...
            c = function (e, t, n, o) {
              var i = s.get(n);
              if ("auto" === t.line && t.vertical) return void e.css(i, "0");
              if ("auto" !== t.line || t.vertical) {
                var r = parseFloat(t.line);
                if (t.snapToLines) {
                  var a = Number(t.line);
                  a < 0 && (a = 21 + a);
                  r = (100 * ((o.height / 21) * a)) / o.height;
                }
                "end" !== t.lineAlign && e.css(i, r + "%"), l(e, t, n, r);
              }
            },
            u = function (e, t, n) {
              switch (t.vertical) {
            ...
            p = function (e, t, n, i) {
              var r = t === o.Right ? "vertical-lr" : "vertical-rl";
              e.css("writing-mode", r), e.css(o.Top, "0"), c(e, n, t, i);
            },
            f = function (e, t, n) {
          ...
          !(function (e) {
            (e.setVttCueBoxStyles = function (e, t) {
              var n = e.vtt,
                r = e.getDomElement();
              a(r, n), (i = g(e.getText())), u(r, n, t);
              var s = "middle" === n.align ? "center" : n.align;
              r.css("text-align", s);
              var l = n.size;
              "" === n.vertical
                ? (r.css("width", l + "%"), f(r, n, o.Left))
                : (r.css("height", l + "%"), f(r, n, o.Top));
            }),
...
window.bitmovin.customMessageHandler.on("toggleCloseSeekbar", function (e) {
  ...
  element.classList.add("red");
  uicontainer.classList.toggle("bmpui-hidden-custom");
  //   i.removeClass(o.prefixCss("controls-shown"));
  //   i.addClass(o.prefixCss("controls-hidden"));
