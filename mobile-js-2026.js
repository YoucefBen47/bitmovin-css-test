    ...
    })(
      {
              ...
              e =
                ...
                (s.prototype.configure = function (e, t) {
                  ...
                  e.on(e.exports.PlayerEvent.AdStarted, function (e) {
                    e = e.ad;
                    (o.setUrl(e.clickThroughUrl),
                      (i = e.clickThroughUrlOpened));
                  });
                  ...
                  e
                    ? (n.onControlsShow.subscribe(function () {
                      ...
                      (t = new y.PlayerUtils.TimeShiftAvailabilityDetector(
                        o,
                      )).onTimeShiftAvailabilityChanged.subscribe(
                        function (e, t) {
                ...
                (i.handleSeekPreview = function (e, t) {
                  ...
                  (i.player.isLive()
                    ...
                    0 < i.appliedMarkerCssClasses.length &&
                      ...
                      (i.appliedMarkerCssClasses = [])),
                    t.marker &&
                      ((t = (t.marker.marker.cssClasses || []).map(
                        function (e) {
        ...
        62: [
          function (e, t, n) {
            ...
            function f(e) {
              ((this._manager = e),
                (this._onChanged = new a.EventDispatcher()));
            }
              ...
              (s.prototype.unsubscribe = function (e) {
                for (var t = 0; t < this.listeners.length; t++) {
                  ...
                  if (n.listener === e)
                    return (
                      n.clear(),
                      l.ArrayUtils.remove(this.listeners, n),
                      !0
                    );
                }
                return !1;
        ...
        96: [
          function (e, t, n) {
            "use strict";
            (Object.defineProperty(n, "__esModule", { value: !0 }),
              (n.getBoundingRectFromElement = n.getElementInDirection =
                void 0));
            var o = e("./types");
            function r(e) {
        ...
        108: [
          function (e, D, t) {
            ...
            (((n = t.UIFactory || (t.UIFactory = {})).buildDefaultUI =
              function (e, t) {
...
(function () {
  if (window.bitmovin && window.bitmovin.customMessageHandler) {
    window.bitmovin.customMessageHandler.on("setZoom", function (data) {
      document.body.classList.toggle("zoom-mode", !!data.zoom);
    });
  } else {
...
window.bitmovin.customMessageHandler.on("setZoom", function (data) {
  console.log("setZoom received", data);
